...
namespace NetCoreKit.Infrastructure.Bus.Kafka
{
    ...
    public class DispatchedEventBus : IDispatchedEventBus
    {
        ...
        public DispatchedEventBus(IServiceProvider serviceProvider, IOptions<KafkaOptions> options,
            ...
            where TMessage : IMessage<TMessage>, new()
        {
                ...
                new ProtoDeserializer<TMessage>()))
            {
                ...
                consumer.OnOffsetsCommitted += (_, commit) =>
                {
                    ...
                    Console.WriteLine(
                        $"[NCK] Subscribe - Successfully committed offsets: [{string.Join(", ", commit.Offsets)}]");
                };
